...
export const M15_ADDITIVE_PROCEDURE_KEYS: Readonly<
  Record<CapabilityDomain, readonly string[]>
> = Object.freeze({
  ...
  "product-business": Object.freeze([
    "product.anti-persona",
    "product.structured-context",
  ]),
